  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white flex items-center justify-center px-4 py-16">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-green-500/8 rounded-full blur-3xl" />
      </div>

      <div className="relative z-10 w-full max-w-2xl">
        <div className="bg-gray-900/80 backdrop-blur-xl border border-green-500/30 rounded-3xl overflow-hidden shadow-2xl">
          {/* Header */}
          <div className="bg-gradient-to-r from-green-500/15 to-emerald-500/10 border-b border-green-500/20 px-8 py-10 text-center">
            <div className="relative inline-flex items-center justify-center mb-5">
              <div className="absolute w-24 h-24 bg-green-500/20 rounded-full animate-ping opacity-30" />
              <div className="relative w-20 h-20 bg-green-500/20 rounded-full flex items-center justify-center ring-2 ring-green-500/40">
          ...
          <div className="px-8 py-8 space-y-6">
                ...
                <div className="divide-y divide-gray-700/40">
                  {orderId && (
                    <OrderRow label="Order ID">
                      <span className="font-mono text-xs text-green-400 break-all">{orderId}</span>
                    </OrderRow>
                  )}
                  {plan && (
                    <OrderRow label="Plan">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-1">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-xl transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-green-900/30"
              >
          ...
          <div className="border-t border-gray-800 px-8 py-4 flex items-center justify-center gap-2 text-gray-600 text-xs">
            ...
            <span>Flash USDT Sender — Secured &amp; Encrypted</span>
          </div>
        </div>
      </div>
    </div>
