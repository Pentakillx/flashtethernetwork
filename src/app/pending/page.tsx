        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border border-amber-500/20 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="px-8 py-7 space-y-4">
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-800/40 border border-gray-700/50 rounded-xl">
              ...
              <div>
                <p className="text-white text-sm font-semibold mb-0.5">{p.checkEmail}</p>
                <p className="text-gray-500 text-xs leading-relaxed">{p.checkEmailDesc}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-800/40 border border-gray-700/50 rounded-xl">
              ...
              <div>
                <p className="text-white text-sm font-semibold mb-0.5">{p.contactSupport}</p>
                <p className="text-gray-500 text-xs leading-relaxed">{p.contactSupportDesc}</p>
              </div>
            </div>
          </div>
