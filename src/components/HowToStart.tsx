      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="px-2 py-0.5 bg-amber-500/30 text-amber-300 rounded-full text-xs font-bold">
                        {step.step}
                      </span>
                    </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl border border-amber-500/30 rounded-2xl p-6 shadow-xl">
              ...
              <div className="space-y-2">
                {SYSTEM_REQUIREMENTS.map((req, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 bg-gray-900/50 rounded-lg border border-amber-500/15 hover:border-amber-500/30 transition-all"
                  >
            ...
            <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl border border-amber-500/30 rounded-2xl p-6 shadow-xl">
              ...
              <div className="space-y-2">
                {NETWORKS.map((network, i) => (
                  <div
                    key={i}
                    className="flex items-center p-3 bg-gray-900/50 rounded-lg border border-amber-500/15 hover:border-amber-500/30 transition-all"
                  >
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
          {STATS.map((stat, i) => (
            <div
              key={i}
              className="text-center p-4 bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-amber-500/20 rounded-xl hover:border-amber-500/40 transition-all duration-300 group"
            >
