          ...
          {PLANS.map((plan) => (
            <div
              ...
              className={`relative rounded-2xl backdrop-blur-sm transition-all duration-300 transform hover:scale-105 ${
                plan.featured
                  ? "md:scale-105 bg-gradient-to-br from-green-900/40 to-gray-900/40 border-2 border-green-500/50 shadow-2xl shadow-green-500/20 mt-4"
                  : "bg-gradient-to-br from-gray-800/40 to-gray-900/40 border-2 border-gray-700/50 hover:border-green-500/30"
              }`}
            >
              {/* Shimmer overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 via-transparent to-green-500/5 rounded-2xl pointer-events-none" />

              {/* Most Popular badge */}
              {plan.featured && (
                <div className="absolute -top-3.5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-green-500 via-green-400 to-green-500 text-gray-900 px-5 py-1 rounded-full text-xs font-bold shadow-xl whitespace-nowrap z-10">
                  Most Popular
                </div>
              )}
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="space-y-1.5 mb-5">
                  {plan.tiers.map((tier, i) => (
                    <div
                      key={i}
                      className="bg-gray-900/60 rounded-lg p-2.5 border border-green-500/10 hover:border-green-500/30 transition-all"
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs text-green-300/70">{tier.limit}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                {/* Divider */}
                <div className="h-px bg-gradient-to-r from-green-500/10 via-green-500/20 to-green-500/10 my-5" />
                  ...
                  {plan.tiers.map((tier) => (
                    <button
                      ...
                      className={`w-full px-4 py-2 rounded-lg font-semibold transition-all text-xs ${
                        plan.featured
                          ? "bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white shadow-lg hover:shadow-green-500/40 transform hover:scale-105"
                          : "bg-gradient-to-r from-gray-700 to-gray-600 hover:from-green-600 hover:to-green-700 text-white hover:scale-105"
                      }`}
                    >
                ...
                {plan.featured && (
                  <p className="text-center mt-3 text-xs text-green-400">
